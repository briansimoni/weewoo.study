...
export default function ProductDetails({ product, variants }: ProductDetailsProps) {
  ...
  const colorVariant = variants.find(v => v.color.name.toLowerCase() === selectedColor.name.toLowerCase());
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 p-4">
      ...
      <div className="lg:w-1/3">
        ...
        {/* Color selection */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-2">Color: {selectedColor.name.replace(/_/g, ' ')}</h3>
          <div className="flex flex-wrap gap-2">
            {colors.map((colorName) => {
              const variantColor = variants.find(v => v.color.name === colorName)?.color;
        ...
        <div className="mt-8 space-y-4">
          <details className="collapse bg-base-200">
            <summary className="collapse-title text-lg font-semibold">Shipping Information</summary>
          ...
          <details className="collapse bg-base-200">
            <summary className="collapse-title text-lg font-semibold">Size Guide</summary>
            <div className="collapse-content">
